 ...
 * Generated at: 2019-11-27 07:03:37 UTC
...
public final class userManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  //获取静态资源的绝对路径
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" 
      ...
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"m-b-none\">用户列表</h3>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 增删改结果提示 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<header class=\"panel-heading\">用户列表</header>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<form action=\"");
      out.print( basePath );
      out.write("user/users\" method=\"post\" data-validate=\"parsley\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- 查询条件 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 150px;\" placeholder=\"请输入用户真实姓名\" value=\"");
      ...
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-rangelength=\"[4,30]\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print( basePath );
      out.write("user/toAdd\" class=\"btn btn-dark btn-sm\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增用户\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print( basePath );
      out.write("user/toAddBatch\" class=\"btn btn-primary btn-sm\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 批量导入用户\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th style=\"text-align: center;\">用户姓名</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th style=\"text-align: center;\">用户名</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th style=\"text-align: center;\">手机号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th style=\"text-align: center;\">所属机构</th>\r\n");
      ...
      if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /WEB-INF/views/user/userManage.jsp(92,14) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          if (_jspx_eval_c_005fwhen_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /WEB-INF/views/user/userManage.jsp(93,15) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
              _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/user/userManage.jsp(93,15) '${page.list}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${page.list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
              // /WEB-INF/views/user/userManage.jsp(93,15) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              try {
                ...
                if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  do {
                    ...
                    out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.usertruename }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
                    out.write("</td>\r\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"line-height: 30px;text-align: center;\">");
                    ...
                    out.write("</td>\r\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"line-height: 30px;text-align: center;\">");
                    out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.institution.instname}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
                    out.write("</td>\r\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"line-height: 30px;text-align: center;\">\r\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
                    ...
                    out.write("\" class=\"btn btn-success btn-sm\">查看</a>\r\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"");
                    out.print( basePath );
                    out.write("user/toModify?userid=");
                    out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.userid}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
                    out.write("\" class=\"btn btn-warning btn-sm\">编辑</a>\r\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar url = host + \"user/users?pageNo=\" + pageNo + \"&pageCount=\" + pageCount \r\n");
  ...
  private boolean _jspx_meth_c_005fwhen_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f1, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/user/userManage.jsp(101,19) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fwhen_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.userstate == 1}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
